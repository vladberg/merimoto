...
<?	
   ...
   <div id="page-wrapper">
		...
		<div class="row">
          <div class="col-lg-10">
            <div class="row">
  	          <div class="col-md-6"><h1>Artículos</h1></div>
  	          <?php
  	          $link=conectarse();
		...
		while($row=mysql_fetch_array($resultado)){
			$visible=$row[0];
  	          ...
  	          ?> 
  	          <div class="col-md-6" align="right"><h2><a href="precios.php?id=<?php echo $visible;?>" class="btn btn-success">Publicar | Despublicar Precios</a></h2></div>
              <div class="col-md-6" align="right"><h2><a href="admin.si.articulos.php?opc=ADD&id=0" class="btn btn-success">Agregar Articulo</a></h2></div>
            </div>
		...
		$query="SELECT id_categoria,categoria FROM categorias where estatus = 1";
		...
		$query="SELECT id_proveedor,nombre FROM proveedores where estatus = 1";
		...
		while($row=mysql_fetch_array($resultado)){
			...
			?>
	     <li><input type="checkbox" name="tipo[]"  value="<?php echo $row[0];?>"> <?php echo $row[1];?></li>
         <?php } ?>
         </ul></td>
