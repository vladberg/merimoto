   ...
   <div id="page-wrapper">
        ...
        <div class="row">
          ...
          <div class="col-lg-10" aling="center">
            ...
            <h2 style="color:#FE0000;padding-left: 150px">ELIMINADOR DE ARTICULOS</h2>
		...
		while($row=mysql_fetch_array($resultado)){
         ...
         <td><input type="submit" class="btn btn-primary" name="guardar" id="guardar" value="Eliminar"></td>
