...
error_reporting(0);
  ...
  //include_once("lib/util.php");
	...
	if($opcion=='UPD'){
		...
		$query="SELECT nombre,imagen,estatus FROM banners where id_banner='$idreg' limit 1";
			...
			if(!empty($_FILES['filefoto']['name'])){
				...
				if(move_uploaded_file($_FILES['filefoto']['tmp_name'], $target_path)) {
					...
					if($idreg!=0){
						//echo $foto;
						 ...
						 $tranx="update banners set nombre='$titulo',imagen='$foto',estatus='$publicar'where id_banner=$idreg";
						...
						echo $tranx="insert into banners (nombre,imagen,estatus,fecha_creacion)  values('$titulo', '$foto',$publicar, CURDATE())";
				...
				if($idreg!=0){
					//echo $foto=$_POST["hiurl"];
					 ...
					 $tranx="update banners set nombre='$titulo',estatus='$publicar'where id_banner=$idreg";
					...
					$tranx="insert into banners (nombre,imagen,estatus,fecha_creacion)  values('$titulo', '$foto',$publicar, CURDATE())";
          ...
          <div class="col-lg-8">
           ...
           <br/>
            ...
            <div class="row" >
             <div class="col-lg-8">
            <div class="row">
  	          <div class="col-md-6"><h2>Nuevo Banner</h2></div>
              </div>
...
informaci&oacute;n. <a href="filtro_banners2.php" onClick="actualizarLista();">Ver lista 
...
informaci&oacute;n. <a href="filtro_banners.php" onClick="actualizarLista();">Ver lista 
