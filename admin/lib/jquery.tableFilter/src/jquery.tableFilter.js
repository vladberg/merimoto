    ...
    prototype: {
        ...
        parseTable: function(){
            ...
            if (this.settings.paging && this.tbody.rows.length){
                ...
                this.pagingRow.append('<td colspan="'+this.cellCount+'" align="left" nowrap="nowrap" valign="middle"><div id="p_base"> <img id="pageFirst" src="'+ip+'/page-first-disabled.gif" align="absmiddle" alt=""> <img id="pagePrev" src="'+ip+'/page-prev-disabled.gif" align="absmiddle" alt="">  Pagina <input id="pageCurrent" size="2" value="1" type="text"> de <span id="pageCount">'+this.maxPage+'</span> <img id="pageNext" src="'+ip+'/page-next.gif" align="absmiddle" alt=""> <img id="pageLast" src="'+ip+'/page-last.gif" align="absmiddle" alt=""> <img src="'+ip+'/toolbar.gif" align="absmiddle" alt=""> Mostrando: <input id="pageRecords" size="2" value="'+this.settings.pageLength+'" type="text"> registros por pagina - (<span id="pageVisible"></span> visible/<span id="pageTotal"></span> total) <img src="'+ip+'/toolbar.gif" align="absmiddle" alt=""> <a id="p_menu_trigger">&nbsp;Menu</a></div></td>')
