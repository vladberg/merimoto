              ...
              <table class="table table-bordered table-hover table-striped tablesorter">
                ...
                <?
                  ...
                  <tr class="<?php echo $class; ?>" id="row<? echo $icont; ?>">
                    <td><a href="admin.si.proveedores.php?<? echo "id=".$row['id_proveedor']."&opc=UPD"; ?>&rowId=row<? echo $icont; ?>"><?php echo $row['id_proveedor'];?></a></td>
                    <td><? echo html_entity_decode($row['nombre'], ENT_QUOTES); ?></td>
                    <td><? echo html_entity_decode($row['codigo'], ENT_QUOTES); ?></td>
                    <td><a href="eliminar_proveedor.php?id=<?php echo $row['id_proveedor']; ?>" onclick="return confirmar('¿Está seguro que desea eliminar el registro?')"><img src="img/delete.gif" border="0"  title="Eliminar Seccion"  style="cursor:pointer;"  /></a></td>
                  </tr>
                  <? }
