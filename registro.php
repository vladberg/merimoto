...
$tranx="insert into registro (nombres,apellidos,email,telefono,usuario,pass,estatus,pass2,empresa,promo) values('$nombre', '$apellido','$email','$telefono','$email',MD5('$pass'),1,'$pass','$empresa',$publicar)";
